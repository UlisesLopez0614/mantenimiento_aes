<template>
    <main class="main">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Historial de Mantenimientos</li>
        </ol>
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="input-group">
                                <input type="text" v-model="buscar" @keyup="listarPrincipal(1, buscar,  desde, hasta)" class="form-control" placeholder="Texto a buscar">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
