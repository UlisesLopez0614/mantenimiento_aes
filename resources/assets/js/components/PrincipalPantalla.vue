                            ...
                            <tbody>
                                <tr v-for="principal in arrayPrincipal" :key="principal.id">
                                    <td style="text-align: center;" class="align-middle">
                                        ...
                                        <template v-if="principal.mantenimiento.costo != null">
                                            <button type="button" @click="abrirRegistro('principal', 'registrar', principal)" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modalNuevo">
                                                <i class="icon-plus"></i>
                                            </button>
                                        </template>
                                        <template v-else>
                                            <template v-if="principal.mantenimiento.idUsuario_Taller!=null && principal.costo ==null">
                                                <button type="button" @click="abrirActualizacion(principal.mantenimiento)" class="btn btn-warning btn-sm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div v-show="errorActualizacionMantenimiento" class="form-group row div-error">
                                <div class="text-center text-error">
                                    <div v-for="error in errorActualizacionMostrarMsjMantenimiento" :key="error" v-text="error">
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="modal-footer">
                        <button type="button" @click="cerrarModalActualizacion()" class="btn btn-danger" data-dismiss="modal">CERRAR</button>
                        <button type="button" @click="actualizarMantenimiento()" class="btn btn-primary">GUARDAR</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            abrirRegistro(modelo, accion, data = []){
                this.nombre = data.id;
                Swal.fire({
                    ...
                    if (result.value) {
                        this.abrirModal('principal', 'registrar', data);
                    }
                });
            },
            abrirActualizacion(data = []){
                this.nombre = data.id;
                Swal.fire({
                    ...
                    if (result.value) {
                        this.abrirModalActualizacion('principal', 'registrar', data);
                    }
                });
            },
