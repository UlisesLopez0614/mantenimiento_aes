<table>
    <thead>
    <tr class="bg-danger">
        <th colspan="11" style="text-align: center;">CONSOLIDADO MANTENIMIENTOS DE CAMBIOS DE LLANTAS</th>
    </tr>
    <tr>
        <th colspan="11" style="text-align: center;">FECHA DE INSTALACION DESDE : {{$desde}}  -   HASTA : {{$hasta}} </th>
    </tr>
    <tr>
        <td colspan="4" style="text-align: center;">VEHICULO</td>
        <td colspan="7" style="text-align: center;">DATOS MANTENIMIENTO</td>
    </tr>
    <tr class="bg-danger">
        ...
        <th style="text-align: center;">TIPO LLANTA</th>
    ...
    @for($i=0; $i<count($arrayMantenimiento); $i++)
        <tr>
            ...
            <td>{{$arrayMantenimiento[$i]->Tipo_Llanta}}</td>
