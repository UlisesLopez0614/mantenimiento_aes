    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    <li @click="menu=2" class="nav-item">
                        <a class="nav-link" href="i#"><i class="icon-wallet"></i> Supervisores</a>
                    </li>
                    <li @click="menu=3" class="nav-item">
                        <a class="nav-link" href="#"><i class="icon-notebook"></i> U. de Medida</a>
                    </li>
                    <li @click="menu=4" class="nav-item">
                        <a class="nav-link" href="i#"><i class="icon-wallet"></i> Talleres</a>
                    </li>
                    <li @click="menu=5" class="nav-item">
                        <a class="nav-link" href="#"><i class="icon-notebook"></i> Items</a>
                    </li>
                    <li @click="menu=6" class="nav-item">
                        <a class="nav-link" href="i#"><i class="icon-wallet"></i> Tipos Manto.</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item nav-dropdown">
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    <li @click="menu=11" class="nav-item">
                        <a class="nav-link" href="i#"><i class="icon-basket-loaded"></i> Asignación</a>
                    </li>
                    <li @click="menu=12" class="nav-item">
                        <a class="nav-link" href="i#"><i class="icon-basket-loaded"></i> Reportes</a>
                    </li>
                </ul>
            </li>
            <li class="nav-title">
            ...
            <li @click="menu=15" class="nav-item">
                <a class="nav-link" href="main.html"><i class="icon-book-open"></i> CONFIGURACIÓN <span class="badge badge-danger">PDF</span></a>
            </li>
        </ul>
    </nav>
